...
test:
	g++  test.cc jsonParser.cc reproject.cc  lib/*.cc -o x $(gdal-config --cflags --libs) -ljsoncpp -lgdal -lpng16 -std=c++23 && ./x

t:
	g++ common/lineofsight.cc  common/operations.cc preprocess/jsonParser.cc preprocess/reproject.cc preprocess/lib/*.cc -o x $(gdal-config --cflags --libs) -ljsoncpp -lgdal -lpng16 -std=c++23 && ./x
